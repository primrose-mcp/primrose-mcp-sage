/**
 * Error Handling Utilities for Sage MCP Server
 *
 ...
 */
export class RateLimitError extends SageApiError {
 ...
 */
export class AuthenticationError extends SageApiError {
 ...
 * Not found error
 */
export class NotFoundError extends SageApiError {
 ...
 * Validation error
 */
export class ValidationError extends SageApiError {
